...
using ResourceryWorkflow.WebApp.Blazor.Client.Menus;
...
[DependsOn(typeof(ResourceryWorkflowWebAppDomainSharedModule))]
...
public class WebAppBlazorClientModule : AbpModule
{
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add(ResourceryWorkflowNames.AdministrationApi);
            options.ProviderOptions.DefaultScopes.Add(ResourceryWorkflowNames.IdentityServiceApi);
            options.ProviderOptions.DefaultScopes.Add(ResourceryWorkflowNames.SaaSApi);
            options.ProviderOptions.DefaultScopes.Add(ResourceryWorkflowNames.WebAppApi);
        });
    }
